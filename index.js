...
(function() {
  ...
  redraw = function() {
    ...
    */
    ...
    var bbox, bottom, bottom_square, characters, codepoints, coords, i, j, left, left_square, meridians, parallels, plane_digits, right, right_square, square_coords, top, top_square, x, x_domain, y, y_domain, _i, _j, _k, _l, _m, _n, _results, _results1;
    x = global.x;
    y = global.y;
    ...
    */
    ...
    y_domain = (function() {
      _results1 = [];
      for (var _j = top; top <= bottom ? _j < bottom : _j > bottom; top <= bottom ? _j++ : _j--){ _results1.push(_j); }
      return _results1;
    }).apply(this).filter(function(d) {
      if (global.zoom.scale() <= 2) {
        return d % 256 === 0;
