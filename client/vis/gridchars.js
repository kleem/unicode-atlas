...
(function() {
  ...
  module.redraw = function(params) {
    var b, bbox, bottom, bottom_square, characters, codepoints, coords, duration, easing, i, j, k, l, left, left_square, m, meridians, n, o, p, parallels, plane_digits, q, r, ref, ref1, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, results, results1, right, right_square, scale, square_coords, t, top, top_square, translate, x_domain, y_domain;
    ...
    x_domain = (function() {
      results = [];
      for (var k = ref = left + 1; ref <= right ? k < right : k > right; ref <= right ? k++ : k--){ results.push(k); }
      return results;
    ...
    y_domain = (function() {
      results1 = [];
      for (var m = ref1 = top + 1; ref1 <= bottom ? m < bottom : m > bottom; ref1 <= bottom ? m++ : m--){ results1.push(m); }
      return results1;
    }).apply(this).filter(function(d) {
      if (index_module.zoom.scale() <= 2) {
        return d % 256 === 0;
    ...
    if (scale > index_module.ZOOM.plane_level && scale <= index_module.ZOOM.codepoints) {
      ...
      for (i = n = ref2 = top_square, ref3 = bottom_square; ref2 <= ref3 ? n < ref3 : n > ref3; i = ref2 <= ref3 ? ++n : --n) {
        for (j = o = ref4 = left_square, ref5 = right_square; ref4 <= ref5 ? o < ref5 : o > ref5; j = ref4 <= ref5 ? ++o : --o) {
          if (i < 64 || j < 16) {
            square_coords.push({
              i: i,
              j: j,
    ...
    if (scale > index_module.ZOOM.characters) {
      for (i = p = ref6 = top, ref7 = bottom; ref6 <= ref7 ? p < ref7 : p > ref7; i = ref6 <= ref7 ? ++p : --p) {
        for (j = q = ref8 = left, ref9 = right; ref8 <= ref9 ? q < ref9 : q > ref9; j = ref8 <= ref9 ? ++q : --q) {
