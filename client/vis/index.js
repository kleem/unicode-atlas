(function() {
  ...
  on_zoom = function() {
    ...
    */
    var duration, easing;
    duration = module.last_zoom_scale === module.zoom.scale() ? 0 : 200;
    easing = 'linear';
    /* transform the layers' root
    */
    module.layers.transition().duration(duration).ease(easing).attr('transform', "translate(" + (module.zoom.translate()) + ") scale(" + (module.zoom.scale()) + ")");
    ...
    */
    return module.last_zoom_scale = module.zoom.scale();
  };
  ...
  window.main = function() {
    ...
    */
    module.path_generator = d3.geo.path().projection(d3.geo.transform({
      point: function(x, y) {
    ...
    /* get data
    */
    return d3.json('data/4_topojson/Blocks.topo.json', function(error, data) {
